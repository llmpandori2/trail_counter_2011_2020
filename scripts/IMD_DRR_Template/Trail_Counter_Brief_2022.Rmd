...
``````{r figure1, echo = F, warning = F, message = F, fig.height = 3, fig.width = 6, out.width = '50%', out.extra = 'style = "float:right; padding 5px"'}
...
```{r echo = F, warning = F, message = F, fig.height = 4, fig.width = 7, out.width = '50%', out.extra = 'style = "float:right; padding 5px"'}
